        ...
        <Card className="max-w-lg border-white/10 bg-white/10 text-white">
          <CardHeader>
            ...
            <CardDescription className="text-white/75">
              Buka halaman transcribe, proses &amp; simpan URL YouTube, lalu kembali ke sini untuk membuat quiz.
            </CardDescription>
          </CardHeader>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="text-white/75">
              ...
              : {quizResult?.youtubeUrl ?? transcriptResult.youtubeUrl ?? "URL tidak tersedia"}
            </p>
          </div>
        ...
        <Card className="border-white/10 bg-white/10 text-white shadow-2xl">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {quizResult?.model ? (
                <span className="text-sm text-white/70">Model: {quizResult.model}</span>
              ) : null}
            </div>
          </CardContent>
        </Card>
